  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "text-body-text size-8 rounded-md border border-solid border-transparent p-0 font-normal transition-none hover:rounded-md",
        !modifiers.selected &&
        ...
        modifiers.selected &&
          ...
          !modifiers.range_end &&
          !modifiers.range_middle &&
          "bg-primary-500 text-inverse-text hover:bg-primary-600 hover:text-inverse-text rounded-l-md",
        modifiers.range_start &&
          "bg-primary-500 text-inverse-text hover:bg-primary-600 hover:text-inverse-text rounded-l-md",
        modifiers.range_middle &&
          "bg-primary-bg text-primary-fg hover:bg-primary hover:text-inverse-text rounded-none",
        modifiers.range_end &&
          "bg-primary-500 text-inverse-text hover:bg-primary-600 hover:text-inverse-text rounded-r-md",
        className,
      )}
      {...props}
    />
