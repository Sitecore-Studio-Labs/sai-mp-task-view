...
interface EditableProps
  extends
    Omit<React.HTMLAttributes<HTMLDivElement>, "onChange" | "onSubmit">,
...
function Editable({
  ...
  return (
    <EditableContext.Provider value={contextValue}>
      <div data-slot="editable" className={cn(editableVariants({ size }), className)} {...props}>
        {children}
      </div>
...
type EditablePreviewProps = React.HTMLAttributes<HTMLSpanElement>;
...
function EditablePreview({ className, ...props }: EditablePreviewProps) {
  ...
  const handleClick =
    activationMode === "click" && isPreviewFocusable && !isDisabled ? startEdit : undefined;
  const handleDoubleClick =
    activationMode === "dblclick" && isPreviewFocusable && !isDisabled ? startEdit : undefined;
...
type EditableInputProps = Omit<React.ComponentProps<typeof Input>, "value" | "onChange">;
...
function EditableInput({ className, ...props }: EditableInputProps) {
  ...
  return (
    <Input
      ...
      className={cn(
        "focus-visible:border-primary w-full border-2 bg-transparent transition-colors focus-visible:ring-0 dark:bg-transparent",
        className,
      )}
      {...props}
    />
...
type EditableTextareaProps = Omit<React.ComponentProps<typeof Textarea>, "value" | "onChange">;
...
function EditableTextarea({ className, ...props }: EditableTextareaProps) {
  ...
  return (
    <Textarea
      ...
      className={cn(
        "focus-visible:border-primary w-36 border-2 bg-transparent transition-colors focus-visible:ring-0 dark:bg-transparent",
        className,
      )}
      {...props}
    />
...
type EditableControlProps = React.HTMLAttributes<HTMLDivElement>;
...
type EditableEditTriggerProps = React.ComponentProps<typeof Button>;
...
type EditableCancelTriggerProps = React.ComponentProps<typeof Button>;
...
type EditableSubmitTriggerProps = React.ComponentProps<typeof Button>;
