...
export function RichTextEditor({
  ...
  if (!editor) {
    return (
      <div
        className={cn(
          "border-input dark:bg-input/30 min-w-0 rounded-md border bg-white px-3 py-2",
          className,
        )}
        style={{ minHeight }}
      >
  ...
  return (
    <div
      ref={setRef}
      className={cn(
        "border-input placeholder:text-muted-foreground focus-within:border-primary focus-within:ring-primary dark:bg-input/30 min-w-0 overflow-hidden rounded-md border bg-white transition-[color] outline-none focus-within:ring-1",
        className,
      )}
      style={{ minHeight }}
    >
            ...
            <div className="grid grid-cols-4 gap-1">
              {TEXT_COLORS.map(({ name, value }) => (
                <button
                  ...
                  type="button"
                  title={name}
                  className="border-border hover:ring-primary/50 size-8 rounded-md border hover:ring-2"
                  style={
                    value
      ...
      <div
        className={cn(
          ...
          "[&_.tiptap_a]:text-primary [&_.tiptap_a]:cursor-pointer [&_.tiptap_a]:underline [&_.tiptap_a]:hover:opacity-90",
...
function ToolbarButton({
  ...
  return (
    <Button
      ...
      colorScheme="neutral"
      className={cn(
        "h-8 w-8 p-0 text-gray-600! [&_svg]:size-4 [&_svg]:text-gray-600!",
