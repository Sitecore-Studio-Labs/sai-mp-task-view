  ...
  return (
    <a
      ...
      className={cn(
        ...
        "text-neutral-fg disabled:text-neutral-fg/40 hover:bg-neutral-bg active:bg-primary-bg bg-transparent font-medium",
        isActive &&
...
function PaginationPrevious({ className, ...props }: React.ComponentProps<typeof PaginationLink>) {
  return (
    <PaginationLink
      ...
      {...props}
    >
      <SvgIcon path={mdiChevronLeft} size={1} />
    </PaginationLink>
  );
}
...
function PaginationNext({ className, ...props }: React.ComponentProps<typeof PaginationLink>) {
  return (
    <PaginationLink
      ...
      {...props}
    >
      <SvgIcon path={mdiChevronRight} size={1} />
    </PaginationLink>
  );
}
...
function PaginationEllipsis({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      {...props}
    >
      <SvgIcon path={mdiDotsHorizontal} size={0.6} />
