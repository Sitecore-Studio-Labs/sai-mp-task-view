...
function DropdownIndicator<Option, IsMulti extends boolean, Group extends GroupBase<Option>>(
  ...
  return (
    <components.DropdownIndicator {...props}>
      <SvgIcon path={mdiChevronDown} className="size-5 opacity-50" />
...
function ClearIndicator<Option, IsMulti extends boolean, Group extends GroupBase<Option>>(
  ...
  return (
    <components.ClearIndicator {...props}>
      <SvgIcon path={mdiClose} className="size-4 opacity-50 hover:opacity-100" />
    </components.ClearIndicator>
  );
}

// Custom multi-value container using Badge component
function MultiValueContainer<Option, IsMulti extends boolean, Group extends GroupBase<Option>>(
...
function MultiValueRemove<Option, IsMulti extends boolean, Group extends GroupBase<Option>>(
  ...
  return (
    <components.MultiValueRemove {...props}>
      <SvgIcon path={mdiClose} className="size-3 opacity-60 hover:opacity-100" />
      ...
      <div className="flex w-full items-center gap-2">
        ...
        {isSelected && (
          <span className="shrink-0">
            <SvgIcon path={mdiCheck} className="size-4" />
          </span>
        )}
      </div>
    </components.Option>
...
>({
  ...
  const classNames: ClassNamesConfig<Option, IsMulti, Group> = {
    ...
    group: () => "",
    groupHeading: () => "text-muted-foreground px-2 py-1.5 text-xs font-semibold uppercase",
