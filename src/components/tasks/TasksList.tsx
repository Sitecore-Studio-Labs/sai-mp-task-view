...
export function TasksList({
  ...
  const testProjectKey = "SCRUM";
  const {
    data: statuses,
    refetch,
    isFetching,
  } = useProjectIssueStatuses(testProjectKey);
  ...
  return (
    <div>
      <Button onClick={handleTestClick} className="mb-4" disabled={isFetching}>
        {isFetching ? "Fetching..." : "Test Get Statuses"}
      </Button>
