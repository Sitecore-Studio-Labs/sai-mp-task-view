...
const DEFAULT_TECH = "React/Next.js frontend, Node.js or Next.js API, and a database (e.g. Postgres/Supabase).";
...
function buildFullProjectBreakdown(
  storyTitle: string,
  storySummary: string,
  techStack: string,
): Node[] {
  const tasks: Node[] = [
      {
        ...
        children: [
          { type: "subtask", title: "Initialize repo and install dependencies", description: "Create project, add core dependencies, and verify scripts (dev, build, test).", children: [] },
          { type: "subtask", title: "Configure lint, format, and tests", description: "Set up ESLint, Prettier, and test runner with a passing smoke test.", children: [] },
          { type: "subtask", title: "Document environment and runbook", description: "Document required env vars and how to run the app locally.", children: [] },
        ],
      },
      {
        type: "task",
        ...
        children: [
          { type: "subtask", title: "Define data model and schema", description: "Document entities, fields, and relationships; add DB migrations or schema if applicable.", children: [] },
          { type: "subtask", title: "Design API endpoints and payloads", description: "List REST or GraphQL endpoints, request/response shapes, and error handling.", children: [] },
          { type: "subtask", title: "Add shared types or API client stubs", description: "Create shared types and optional API client or OpenAPI spec.", children: [] },
        ],
      },
      {
        type: "task",
        ...
        children: [
          { type: "subtask", title: "Implement API routes and handlers", description: "Implement each endpoint with validation and error responses.", children: [] },
          { type: "subtask", title: "Add business logic and data access", description: "Implement use cases and data access (DB or services).", children: [] },
          { type: "subtask", title: "Write API and unit tests", description: "Add tests for handlers and business logic.", children: [] },
        ],
      },
      {
        type: "task",
        ...
        children: [
          { type: "subtask", title: "Implement page layout and navigation", description: "Add routes, layout, and navigation for the main flows.", children: [] },
          { type: "subtask", title: "Build main views and components", description: "Implement primary screens and reusable components.", children: [] },
          { type: "subtask", title: "Wire UI to APIs and state", description: "Connect components to API calls and state (e.g. React Query, form state).", children: [] },
          { type: "subtask", title: "Add loading and error handling in UI", description: "Show loading and error states and basic a11y.", children: [] },
        ],
      },
      {
        type: "task",
        ...
        children: [
          { type: "subtask", title: "End-to-end integration and smoke test", description: "Run through main user flows and fix integration bugs.", children: [] },
          { type: "subtask", title: "Add E2E tests for critical paths", description: "Add E2E tests for main happy paths.", children: [] },
          { type: "subtask", title: "Accessibility and responsiveness check", description: "Verify a11y and responsive behavior on key screens.", children: [] },
        ],
      },
      {
        type: "task",
        ...
        children: [
          { type: "subtask", title: "Update README and feature docs", description: "Document how to run, test, and use the feature.", children: [] },
          { type: "subtask", title: "Verify build and deploy pipeline", description: "Ensure CI/CD builds and deploys the app successfully.", children: [] },
        ],
      },
  ];
...
function inferTechStack(text: string): string {
  ...
  if (lower.includes("react") || lower.includes("next")) return "Next.js/React frontend with API routes or a separate Node backend, and a database.";
  if (lower.includes("mobile") || lower.includes("react native")) return "React Native (or Flutter) for mobile, plus backend API and database.";
  return DEFAULT_TECH;
}
...
export function stubParseRequirements(requirementText: string): { items: unknown[] } {
  ...
  const items = buildFullProjectBreakdown(storyTitle, storySummary, techStack);
