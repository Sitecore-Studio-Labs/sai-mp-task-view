...
create table if not exists public.jira_site_project_mappings (
  ...
  -- Per-site Jira instance override
  -- Only relevant when the user's account has access to multiple Jira cloud instances.
  jira_site_id          text,
  jira_site_url         text,
  jira_site_name        text,
